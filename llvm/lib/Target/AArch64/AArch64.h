...
FunctionPass *createAArch64OpaquePredicatePass();
FunctionPass *createAArch64ISelDag(AArch64TargetMachine &TM,
                                   CodeGenOptLevel OptLevel);
FunctionPass *createAArch64StorePairSuppressPass();
FunctionPass *createAArch64CallRetObfuscationPass();
...
void initializeAArch64CallRetObfuscationPass(PassRegistry &);
void initializeAArch64OpaquePredicatePass(PassRegistry &);
