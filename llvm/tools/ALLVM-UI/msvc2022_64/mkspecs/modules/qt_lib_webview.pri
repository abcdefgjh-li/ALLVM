...
QT.webview.disabled_features = webview-webview2-plugin webview-webengine-plugin webview-android-plugin webview-darwin-plugin webview-winrt-plugin webview-wasm-plugin
QT_CONFIG += 
QT_MODULES += webview
