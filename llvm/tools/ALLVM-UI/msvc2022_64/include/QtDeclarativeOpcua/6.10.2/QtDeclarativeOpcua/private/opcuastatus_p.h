...
public:
    enum class Status {
        ...
        BadCertificatePolicyCheckFailed = 0x8114,
        ...
        BadLicenseExpired = 0x810E,
        BadLicenseLimitsExceeded = 0x810F,
        BadLicenseNotAvailable = 0x8110,
        ...
        BadRequestNotComplete = 0x8113,
        BadTransactionPending = 0x80E8,
        BadTicketRequired = 0x811F,
        BadTicketInvalid = 0x8120,
        BadLocked = 0x80E9,
        GoodEdited = 0x00DC,
        ...
        GoodEdited_DependentValueChanged = 0x0116,
        GoodEdited_DominantValueChanged = 0x0117,
        GoodEdited_DominantValueChanged_DependentValueChanged = 0x0118,
        BadEdited_OutOfRange = 0x8119,
        BadInitialValue_OutOfRange = 0x811A,
        BadOutOfRange_DominantValueChanged = 0x811B,
        BadEdited_OutOfRange_DominantValueChanged = 0x811C,
        BadOutOfRange_DominantValueChanged_DependentValueChanged = 0x811D,
        BadEdited_OutOfRange_DominantValueChanged_DependentValueChanged = 0x811E,
        ...
        UncertainTransducerInManual = 0x4208,
        UncertainSimulatedValue = 0x4209,
        UncertainSensorCalibration = 0x420A,
        UncertainConfigurationError = 0x420F,
        GoodCascadeInitializationAcknowledged = 0x0401,
        GoodCascadeInitializationRequest = 0x0402,
        GoodCascadeNotInvited = 0x0403,
        GoodCascadeNotSelected = 0x0404,
        GoodFaultStateActive = 0x0407,
        GoodInitiateFaultState = 0x0408,
        GoodCascade = 0x0409,
        BadDataSetIdInvalid = 0x80E7,
    };
    Q_ENUM(Status)
