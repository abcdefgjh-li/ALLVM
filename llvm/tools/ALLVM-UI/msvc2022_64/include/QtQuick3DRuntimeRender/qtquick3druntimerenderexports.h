...
#include <QtCore/qtconfigmacros.h> // Q_QUICK3DRUNTIMERENDER_EXPORT
...
#  define QT_QUICK3DRUNTIMERENDER_CONSTEXPR_INLINE_SINCE(major, minor) constexpr
...
#  define QT_QUICK3DRUNTIMERENDER_CONSTEXPR_INLINE_SINCE(major, minor) \
