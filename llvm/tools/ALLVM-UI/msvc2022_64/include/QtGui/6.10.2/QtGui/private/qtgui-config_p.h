#ifndef QT_FEATURES_Gui_qtbase_src_gui_qtgui_config_p_h_H
#define QT_FEATURES_Gui_qtbase_src_gui_qtgui_config_p_h_H
...
#endif // QT_FEATURES_Gui_qtbase_src_gui_qtgui_config_p_h_H
