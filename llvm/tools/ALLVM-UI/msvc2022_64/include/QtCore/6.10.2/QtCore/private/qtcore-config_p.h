#ifndef QT_FEATURES_Core_qtbase_src_corelib_qtcore_config_p_h_H
#define QT_FEATURES_Core_qtbase_src_corelib_qtcore_config_p_h_H
...
#endif // QT_FEATURES_Core_qtbase_src_corelib_qtcore_config_p_h_H
