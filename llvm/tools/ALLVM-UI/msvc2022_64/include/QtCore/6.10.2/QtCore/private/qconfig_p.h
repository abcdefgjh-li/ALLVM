#ifndef QT_FEATURES_GlobalConfig_qtbase_src_corelib_global_qconfig_p_h_H
#define QT_FEATURES_GlobalConfig_qtbase_src_corelib_global_qconfig_p_h_H
...
#endif // QT_FEATURES_GlobalConfig_qtbase_src_corelib_global_qconfig_p_h_H
